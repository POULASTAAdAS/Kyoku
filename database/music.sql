...
SELECT id FROM song WHERE artist LIKE '%A.R. Rahman%';

select * from artist where name like '%Kyokui.Com%';

select * from artist;


select * from artist where id = 2373;
...
select * from song where masterPlaylistPath like "F:/songs/master/%";
