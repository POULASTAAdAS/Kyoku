...
interface SynRepository {
    suspend fun <T> syncData(type: DtoSyncType, idList: List<Long>): DtoSyncPayload<T>
    suspend fun syncPlaylistSongs(idList: List<Pair<PlaylistId, List<SongId>>>): DtoSyncPlaylistSongPayload
}