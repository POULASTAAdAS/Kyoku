...
import com.poulastaa.kyoku.data.model.api.service.artist.SongListResponse
...
interface ServiceApi {
    ...
    @POST("api/authorised/getSongOnListonIdList")
    suspend fun getSongOnListonIdList(
        @Body request: SongListReq
    ): SongListResponse
}